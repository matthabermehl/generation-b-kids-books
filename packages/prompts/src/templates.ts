...
function storyModePolicyBlock(): string[] {
  return [
    "Obey the supplied story_mode exactly via this story-mode policy seam:",
    ...orderedStoryModes.map((mode) => `- ${mode.key}: ${mode.promptSummary}`)
  ];
}
